...
class MinimumDistanceToTypeWordUsingTwoFingersTest3 {

    private MinimumDistanceToTypeWordUsingTwoFingers3 sut;

    @BeforeEach
    void setUp() {
        sut = new MinimumDistanceToTypeWordUsingTwoFingers3();
    }
